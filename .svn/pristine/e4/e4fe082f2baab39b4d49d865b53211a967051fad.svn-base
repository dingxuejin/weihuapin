      ...
      <transition name="fade">
        <div class="wrapDetailsBox"
          ...
          <div class="detailsItem endDate">
            ...
            <div class="content"
                 v-if="clbxjcData">{{formatDate(clbxjcData.insurance_end_date||'')}}</div>
          </div>
        </div>
      </transition>
      <transition name="fade">
        <div class="wrapDetailsBox"
          ...
          <div class="detailsItem endDate">
            ...
            <div class="content"
                 v-if="clbxjcData">{{clbxjcData.insurance_area}}</div>
          </div>
        </div>
      </transition>
      <div class="prevBtn"
...
export default {
  ...
  methods: {
    scrollContent_h_3(i) {
      ...
      if (this.detailesBoxShow_h_3 > 2 || this.detailesBoxShow_h_3 < 1) {
