  ...
  <div class="dbase">
    ...
    <div class="driver_infoCon clearfix"
      ...
      <div class="driver_infoCon_left fl">
        ...
        <div class="appraiseMsg" v-show="appraiseMsgShow">
...
export default {
    ...
    healthyState() {
      if (
        ...
        const time =
          ...
          365 * 2 * 24 * 3600 * 1000 -
          new Date().getTime()
        if (30 * 2 * 24 * 3600 * 1000 < time && time < 90 * 2 * 24 * 3600 * 1000) {
          return 3
        } else if (time > 0 && time < 30 * 2 * 24 * 3600 * 1000) {
          return 1
        }
        return 0
      }
  ...
  methods: {
    ...
    appraiseMsgShowIf() {
      this.appraiseMsgShow = !this.appraiseMsgShow
    },
  },
  data() {
    return {
