<template>
  <div class="costStatisticsDetailsPopupbig_wrap"
    ...
    <!-- 调用数据 -->
    <div v-show="false">{{getcarFuelvsMileageData}}</div>
...
export default {
  ...
  computed: {
    ...
    getcarFuelvsMileageData() {
      const length =
        this.carFuelvsMileageData &&
        this.carFuelvsMileageData !== undefined &&
        this.carFuelvsMileageData !== null &&
        this.carFuelvsMileageData[1] &&
        this.carFuelvsMileageData[1].data &&
        this.carFuelvsMileageData[1].data.length &&
        Number(this.carFuelvsMileageData[1].data.length);
      const data = [
        {
          name:
            this.carFuelvsMileageData &&
            this.carFuelvsMileageData !== undefined &&
            this.carFuelvsMileageData !== null &&
            this.carFuelvsMileageData[0] &&
            this.carFuelvsMileageData[0].name &&
            this.carFuelvsMileageData[0].name,
          data:
            this.carFuelvsMileageData &&
            this.carFuelvsMileageData !== undefined &&
            this.carFuelvsMileageData !== null &&
            this.carFuelvsMileageData[0] &&
            this.carFuelvsMileageData[0].data &&
            this.carFuelvsMileageData[0].data.slice(-length)
        },
        {
          name:
            this.carFuelvsMileageData &&
            ...
            this.carFuelvsMileageData !== null &&
            this.carFuelvsMileageData[1] &&
            this.carFuelvsMileageData[1].name &&
            this.carFuelvsMileageData[1].name,
          data:
            this.carFuelvsMileageData &&
            this.carFuelvsMileageData !== undefined &&
