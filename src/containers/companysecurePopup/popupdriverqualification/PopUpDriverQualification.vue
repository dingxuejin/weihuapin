<template>
  <div>
    ...
    <div class='qualify' v-if="ryjb">
      <div class='qualify_wrap' v-if="popUpDriverLicense">
        <!-- 驾驶证 -->
            ...
            <div class="indexDetailsCon clearfix">
              ...
              <div class="detailsItem fl clearfix">
                ...
                <div class="fl clearfix">
                  ...
                  <div class="fl">
                    {{formatDate(popUpDriverLicense.effective_date)}}
                    至
                    {{formatDate(popUpDriverLicense.expire_date)}}
                  </div>
                </div>
              </div>
      ...
      <div class='qualify_wrap' v-if="popUpWorkQualification">
        <!-- 从业资格证 -->
