  ...
  <div>
    ...
    <div class="illegalBehaviorDetailsInfoCon">
      ...
      <div class="rewardListCon eleScrollBar">
        <list-component :listData="illegalBehaviorDetailsInfo"
                        v-if="illegalBehaviorDetailsInfo"
...
export default {
  ...
  computed: {
    ...mapState('illegalbehaviordetailsinfo', ['illegalBehaviorDetailsInfo']),
  ...
  methods: {
    ...mapActions('illegalbehaviordetailsinfo', [
      'getIllegalBehaviorDetailsInfo',
    ]),
    select(name, item) {
  ...
  data() {
    return {
      ...
      cycleDatedata: day,
      titlesData: [
        { name: '车辆ID', key: 'vehicle_id', width: 150 },
        { name: '线路ID', key: 'route_id', width: 150 },
        { name: '报警类型', key: 'jssjlx.drive_event_type', width: 350 },
        { name: '速度', key: 'speed', width: 150 },
        { name: '方向', key: 'direction', width: 150 },
        { name: '报警时间', key: 'illegaltype_time', width: 150 },
