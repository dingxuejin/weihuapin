        ...
        <div class="itemCon fr clearfix">
          ...
          <div class="fl">
            <key-value-select width="130px"
                              ...
                              @select='selectType("selectType",$event)'></key-value-select>
          </div>
...
export default {
  ...
  computed: {
    ...mapState('driverbehavioralarmcountinfo', ['driverBehaviorAlarmCountInfo']),
