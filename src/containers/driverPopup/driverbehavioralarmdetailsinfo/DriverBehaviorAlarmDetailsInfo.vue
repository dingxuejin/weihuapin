<template>
  <div>
    <pop-up-widget title="驾驶行为详细信息"></pop-up-widget>
    <div class="trainDetailsInfoCon">
      ...
      <div class="rewardListCon eleScrollBar">
        <list-component :listData="driverBehaviorAlarmDetailsInfo"
                        :titlesData="titlesData"
                        v-if="driverBehaviorAlarmDetailsInfo"></list-component>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState('driverbehavioralarmdetailsinfo', ['driverBehaviorAlarmDetailsInfo']),
  ...
  methods: {
    ...mapActions('driverbehavioralarmdetailsinfo', ['getDriverBehaviorAlarmDetailsInfo']),
    select(name, item) {
  ...
  data() {
    return {
      ...
      titlesData: [
        ...
        { name: '线路ID', key: 'route_id', width: 200 },
        { name: '报警类型', key: 'jssjlx.drive_event_type', width: 100 },
        { name: '速度', key: 'speed', width: 100 },
        { name: '方向', key: 'direction', width: 100 },
        { name: '报警时间', key: 'alarm_time', width: 200 },
        { name: '纬度', key: 'latitude', width: 100 },
        { name: '经度', key: 'longitude', width: 100 },
      ],
      selectYearData: year,
