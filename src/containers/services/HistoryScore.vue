<template>
    <div class="HistoryScore">
      <div class="HistoryScore_wrap">
        <div class="facilitatorScore">
        <div class="facilitatorScore_title">服务商历史评分
          <div class="facilitatorScore_title_date">统计周期
        ...
        <div class="facilitatorScore_content">
          <div class="listTitle">
            <div>服务商</div>
      ...
      <div class="businessScore">
        <div class="businessScore_title">企业历史评分
          <div class="businessScore_title_date">统计周期
            <div class="dataSelect">
              <el-date-picker
                v-model="value6"
                type="daterange"
        ...
        <div class="businessScore_content">
          <div class="listTitle">
            <div>企业</div>
            <div v-for='(item,index) in listTitle'
                :key='index'>{{item}}</div>
