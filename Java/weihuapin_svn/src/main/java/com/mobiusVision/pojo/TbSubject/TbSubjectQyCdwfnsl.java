...
public class TbSubjectQyCdwfnsl {
    private Integer tb_subject_qy_cdwfnsl_id;
    ...
    public Integer getTb_subject_qy_cdwfnsl_id() {
        return tb_subject_qy_cdwfnsl_id;
    }

    public void setTb_subject_qy_cdwfnsl_id(Integer tb_subject_qy_cdwfnsl_id) {
        this.tb_subject_qy_cdwfnsl_id = tb_subject_qy_cdwfnsl_id;
    }
