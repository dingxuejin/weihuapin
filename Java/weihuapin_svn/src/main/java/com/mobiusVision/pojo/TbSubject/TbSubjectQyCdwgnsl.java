...
public class TbSubjectQyCdwgnsl {
    private Integer tb_subject_qy_cdwgnsl_id;
    ...
    public Integer getTb_subject_qy_cdwgnsl_id() {
        return tb_subject_qy_cdwgnsl_id;
    }

    public void setTb_subject_qy_cdwgnsl_id(Integer tb_subject_qy_cdwgnsl_id) {
        this.tb_subject_qy_cdwgnsl_id = tb_subject_qy_cdwgnsl_id;
    }
