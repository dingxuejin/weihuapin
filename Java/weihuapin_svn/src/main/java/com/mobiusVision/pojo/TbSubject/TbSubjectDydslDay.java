...
public class TbSubjectDydslDay {
    private Integer tb_subject_dydsl_day_id;
    ...
    public Integer getTb_subject_dydsl_day_id() {
        return tb_subject_dydsl_day_id;
    }

    public void setTb_subject_dydsl_day_id(Integer tb_subject_dydsl_day_id) {
        this.tb_subject_dydsl_day_id = tb_subject_dydsl_day_id;
    }
