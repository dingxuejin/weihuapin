 ...
 * @Modify By:
 **/
@Api(description ="不同企业高危驾驶行为相关接口")
@Controller
public class TbSubjectQyCdgwNandYslTDJController {
    ...
    @ApiOperation(value = "查询不同企业高危驾驶行为某一年的数据",
    ...
    @ApiOperation(value = "查询不同企业高危驾驶行为某一月的数据",
            notes = "年和月不填则查询当年当月",httpMethod = "GET")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType="query", name = "entity_id", value = "企业编号", required = true, dataType = "String",defaultValue = "1310000010000000"),
            @ApiImplicitParam(paramType="query", name = "year", value = "年份", required = true, dataType = "String",defaultValue = "2017"),
    ...
    @ApiOperation(value = "查询不同企业高危驾驶行某一年和月的总数据（企业必选，年份和月份不必须）",
            notes = "年和月不填则查询当年当月",httpMethod = "GET")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType="query", name = "entity_id", value = "企业编号", required = true, dataType = "String",defaultValue = "1310000010000000"),
            @ApiImplicitParam(paramType="query", name = "year", value = "年份", required = true, dataType = "String",defaultValue = "2017"),
